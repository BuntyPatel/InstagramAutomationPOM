...
import com.ig.qa.util.TestUtil;
...
public class TestBase {
	...
	public TestBase() {
		...
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream("/Users/bunty/Desktop/QA/Selenium_WorkSpace/InstagramTestAutomation/src/main/java/com/ig/qa/config/config.properties");
			prop.load(ip);
